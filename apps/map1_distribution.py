...
if mapping_unit == 'Researchers':
    data_shade_center_table = 'autC'
    column_identifier = 'name'
    sort_column = 'weight'
    data_shade_points_table = 'autD'
    ...
    column_identifier = 'inst'
    sort_column = 'weight'
    data_shade_points_table = 'insD'
    #data_keywords_table = 'insK'
    data_papers_table = 'papI'
elif mapping_unit == 'Keywords':
    data_shade_center_table = 'keyC'
    column_identifier = 'keyword'
    sort_column = 'degree'
...
with st.expander("Workspace and data bases ..."):
    ...
    overlay_db = my_workspace + st.text_input('Selected map data base: ', default_map_db)  
...
if show_captions:
    for i in range(0,number_of_labels):
        ...
        texts.append(plt.text(labx, laby, label_text[i], alpha=cat_txt_transp, \
            size=label_size[i], weight = 'normal', style='italic', color=cat_txt_col))      
