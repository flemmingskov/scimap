...
list_secondary_paths = ['scimap/rewilding/', 'scimap/ecos/ECOS/', 'scimap/ecos/OhLand/', 'scimap/ecos/cVand/', 'scimap/zoophys/', 'scimap/cognition/','scimap/sect/',  'scimap/cognition/', 'scimap/PLOS/au_biology/']
