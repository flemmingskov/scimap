...
list_secondary_paths = ['skovprojekt/map/', 'scimap/ecos/ECOS/', 'scimap/ecos/rewilding/', 'scimap/ecos/OhLand/', 'scimap/ecos/cVand/', 'scimap/zoophys/', 'scimap/cognition/','scimap/sect/',  'scimap/cognition/', 'scimap/PLOS/au_biology/']
